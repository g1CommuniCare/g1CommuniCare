    ...
    return (
        <div className="w-full h-full">
            ...
            <div
                ...
                style={{ backgroundImage: 'url("images/dashboard/dashboard_bgimage.png")' }}
            >
                ...
                <p className="text-[#1F394A] w-[1000px] font-serif text-lg text-justify leading-[30px]">
                    With CommuniCare, Unlock seamless barangay engagement through streamlined
                    services, including document requests, report filing, and a hassle-free
                    appointment system. Experience the revolution in local living – where efficiency
                    meets empowerment for a stronger, connected community. Elevate your experience
                    with Communicare today!
                </p>
                ...
                <div className="w-full flex flex-col items-center justify-center gap-16 mt-20">
                    ...
                    <div className="w-[1250px] flex justify-center items-center gap-10">
                        ...
                        <p className="text-[#1F394A] text-xl w-[65%] text-justify font-medium">
                            ...
                            <span className="font-serif font-medium">
                                . Our mission is simple but powerful: to bring the residents of our
                                barangay closer together through the convenience of technology.
                            </span>
                        </p>
                    </div>
                </div>
            ...
            <div className="flex flex-col gap-10 items-center justify-start mt-20 w-full">
                ...
                <div className="flex w-full h-[311px]">
                    <div
                        ...
                        style={{ backgroundImage: 'url("images/dashboard/philosophy.png")' }}
                    >
                        <div className="text-justify text-white text-xl w-[400px] font-sans">
                            Living in a connected world, we recognized the need for a platform that
                            fosters community engagement. With this app, we aim to bridge the gap
                            between residents, providing a space for seamless document requests,
                            efficient report filing, appointment scheduling, and easy access to
                            local resources.
                        </div>
                    </div>
                    <div className="bg-[#2e64b0] flex flex-col justify-center items-center w-1/2">
                        <div className="text-justify text-white text-xl w-[400px] font-sans">
                            We believe in the strength of unity, and this app is our contribution to
                            making our barangay a more connected and informed community. Join us in
                            embracing a new era of community interaction, where updates, engagement,
                            and a sense of togetherness are just a click away.
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="flex justify-center items-start gap-[75px]">
                    <div className="w-[420px] text-[#1F394A]">
                        ...
                        <p className="text-justify font-serif text-xl leading-8 mt-8">
                            As enthusiastic students immersed in technology, we saw an opportunity
                            to leverage connectivity for a greater purpose. Our app is a digital
                            nexus, meticulously designed to simplify and enhance how residents
                            interact. It's not just about technology; it's about fostering
                            relationships and building a stronger sense of community.
                        </p>
                    </div>
                    <img
            ...
            {/* FOOTER */}
            <footer className="flex flex-col justify-center items-center gap-10 pt-20">
                <div className="bg-[#1f394a] h-2 w-10/12"></div>
                <div className="flex justify-between items-center w-10/12 pb-10">
                    <div className="flex flex-col gap-1 text-[#1F394A]">
                    ...
                    <div className="flex">
                        <img src="/images/dashboard/img_footer.png" alt="" className="w-72 h-24" />
                    </div>
                </div>
            </footer>
        </div>
