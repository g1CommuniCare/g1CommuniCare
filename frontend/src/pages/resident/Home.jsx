...
const Home = () => {
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-sans items-center justify-end mx-auto w-[1184px]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start w-full">
            <div className="bg-#ffffff flex flex-col items-center justify-start pb-[43px] static w-full">
              <div className="flex flex-col items-center justify-start w-full">
                ...
                <Text
                  style={{ color: "#1f394a" }}
                  className="mt-[116px] sm:text-[40px] md:text-[40px] text-[44px] text-blue_gray-900 text-center font-librefranklin font-extrabold"
                  size="txtLibreFranklinRomanExtraBold44"
                >
                  This is the Future of Community Empowerment
                </Text>
                <Text
                  className="leading-[30.00px] mt-[26px] text-[22px] text-blue_gray-900 text-justify sm:text-lg md:text-xl tracking-[-0.44px] w-[73%] w-[85%] font-robotoserif font-medium"
                ...
                <div className="flex flex-row font-librefranklin sm:gap-5 items-center justify-center md:ml-auto ml-auto w-[1000px] h-[349px] mx-auto mb-[-100px]">
                  ...
                  <div className="flex flex-col items-center justify-start w-[93%] md:w-full">
                    <div className="flex flex-col gap-5 items-center justify-start w-full">
                      ...
                      <div className="flex flex-row md:gap-5 items-center justify-between items-center w-[955px]">
                        <Text
                          className="text-base text-[#1f394a] font-sans font-bold"
                          size="txtRobotoMedium16Bluegray900"
                        >
                          Bianca Jessa Carabio
                        </Text>
                        <Text
                          className="text-base text-[#1f394a] font-sans font-bold mr-7"
                          size="txtRobotoMedium16Bluegray900"
                        >
                          Joshua Jhonn Borres
                        </Text>
                        <Text
                          className="text-base text-[#1f394a] font-sans font-bold mr-6"
                          size="txtRobotoMedium16Bluegray900"
                        >
                          France Gieb Mier
                        </Text>
                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-center justify-evenly w-full">
                      ...
                      <div className="flex flex-row font-roboto md:gap-20 gap-[75px] items-center justify-start w-[84%] md:w-full ml-20">
                        <div className="flex flex-col font-roboto md:gap-10 gap-[75px] items-start justify-start w-[84%] md:w-full">
                          ...
                          <Text className="inset-x-[0] mx-auto overflow-y-clip relative text-justify text-[#1f394a] text-xl top-[14%] w-[450px] mt-[10px] font-sans font-medium">
                            <>
                              As enthusiastic students immersed in technology,
                              we saw an opportunity to leverage connectivity for
                              a greater purpose. Our app is a digital nexus,
                              meticulously designed to simplify and enhance how
                              residents interact. It&#39;s not just about
                              technology; it&#39;s about fostering relationships
                              and building a stronger sense of community.
                            </>
                          </Text>
                        </div>
                        <Img
                          className="h-[389px] sm:h-auto mr-[100px] mt-[118px] object-cover w-[50%]"
                    ...
                    <div className="flex flex-row font-roboto-medium md:gap-20 gap-[75px] items-center justify-start mt-13 w-[84%] md:w-full ml-20">
                      ...
                      <div className="flex flex-col gap-[30px] items-start justify-start ml-auto md:ml-[0] ml-[100px]">
                        ...
                        <Text className="leading-[30.00px] md:ml-[0] ml-[100px] text-[22px] text-[#1f394a] text-justify sm:text-lg md:text-xl tracking-[-0.66px] w-[80%] font-sans font-medium">
